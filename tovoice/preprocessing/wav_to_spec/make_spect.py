...
class MakeSpecs():
    ...
    def generate_wave_forms(self, wav_files):
        wave_forms = []
    ...
    def wavs_to_butters(self, wave_forms, cutoff=30, fs=16_000, order=5):
        nyq = 0.5 * fs
    ...
    def generate_mel_specs(self, butter_files):
        mel_specs = []
    ...
    def display_mel_specs(self, mel_specs):
        nb_cols = 5
    ...
    def save_mel_specs(self, mel_specs, wav_files, speaker_spects_dir):
        for i, mel_spec in enumerate(mel_specs):
